...
export function CharacterClient({
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-1 xl:grid-cols-[minmax(0,320px)_minmax(0,1fr)_minmax(0,360px)] 2xl:grid-cols-[minmax(0,380px)_minmax(0,1fr)_minmax(0,420px)]">
